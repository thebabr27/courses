...
class SBuild {
		...
		a(id, classes, attributes, arr) {
			...
			return a.sopen(id, "", classes, attributes)+
			items+
			a.close();
		}
		...
		form(id, txt, classes, attributes, arr) {
			...
			return form.sopen(id, txt, classes, attributes)+
			items+
			form.close();
		}
		...
		nav(id, classes, attributes, arr) {
			...
			return nav.sopen(id, "", classes, attributes)+
			items+
			nav.close();
		}
		...
		button(id, classes, attributes, arr) {
			...
			return but.sopen(id, "", classes, attributes)+
			items+
			but.close();
		}
		...
		container(id, classes, attributes, arr) {
			...
			return container.sopen(id, "", classes, attributes)+
			items+
			container.close();
		}
		...
		h1(id, txt, classes, attributes, arr) {
			...
			return h1.sopen(id, txt, classes, attributes)+
			items+
			h1.close();
		}
		...
		h2(id, txt, classes, attributes, arr) {
			...
			return h2.sopen(id, txt, classes, attributes)+
			items+
			h2.close();
		}
		...
		h3(id, txt, classes, attributes, arr) {
			...
			return h3.sopen(id, txt, classes, attributes)+
			items+
			h3.close();
		}
		...
		h4(id, txt, classes, attributes, arr) {
			...
			return h4.sopen(id, txt, classes, attributes)+
			items+
			h4.close();
		}
		...
		h5(id, txt, classes, attributes, arr) {
			...
			return h5.sopen(id, txt, classes, attributes)+
			items+
			h5.close();
		}
		...
		h6(id, txt, classes, attributes, arr) {
			...
			return h6.sopen(id, txt, classes, attributes)+
			items+
			h6.close();
		}
		...
		main(id, classes, attributes, arr) {
			...
			return main.sopen(id, "", "container "+classes, attributes)+
			items+
			main.close();
		}
		...
		icontainer(id, txt, classes, attributes, arr) {
			...
			return container.sopen(id, txt, classes, attributes)+
			items+
			container.close();
		}
		...
		div(id, classes, attributes, arr) {
			...
			return div.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			div.sclose();
		}
		...
		idiv(id, txt, classes, attributes, arr) {
			...
			return div.sopen(id, txt, classes, attributes)+
			items+
			div.close();
		}
		...
		footer(id, classes, attributes, arr) {
			...
			return foot.sopen(id, "", classes, attributes)+
			items+
			foot.close();
		}
		...
		row(id, classes, attributes, arr) {
			...
			return row.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			row.close();
		}
		...
		irow(id, txt, classes, attributes, arr) {
			...
			return row.sopen(id, txt, classes, attributes)+
			items+
			row.close();
		}
		...
		col(id, classes, attributes, arr) {
			var items = '';
			for (var i=0; i<arr.length;i++) {
				items+=div.sopen(id, "", "col"+'"'+classes, attributes)+arr[i]+'"'+div.close();
			}
			return items;
	...
	section(id, classes, attributes, arr) {
		...
		return section.sopen(id, "", classes, attributes)+'"+'+
		items+'"'+
		section.close();
	}	
	...
	span(id, txt, classes, attributes, arr) {
		...
		return span.sopen(id, txt, classes, attributes)+'"+'+
		items+'"'+
		span.close();
	}
		...
		li(id, classes, attributes, arr) {
			...
			return li.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			li.close();
		}
		...
		list(id, txt, classes, attributes, arr, commonclass) {
			...
			for (var i=0; i<arr.length;i++) {
				items+=li.sopen("","",commonclass,"")+arr[i]+li.close();
			}
			return ul.sopen(id, txt, classes, attributes)+'"+'+
			items+'"'+
			ul.close();
		}
		...
		ul(id, classes, attributes, arr) {
			...
			return ul.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			ul.close();
		}
		...
		containerfluid(id, classes, attributes, arr) {
			...
			return containerfluid.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
		...
		table(id, classes, attributes, arr) {
			...
			return table.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			table.sclose();
		}
		...
		thead(id, classes, attributes, arr) {
			...
			return thead.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			thead.sclose();
		}
		...
		tbody(id, classes, attributes, arr) {
			...
			return tbody.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			tbody.sclose();
		}
		...
		tr(id, classes, attributes, arr) {
			...
			return tr.sopen(id, "", classes, attributes)+'"+'+
			items+'"'+
			tr.sclose();
		}
		...
		td(id, txt, classes, attributes, arr) {
			...
			return td.sopen(id, txt, classes, attributes)+'"+'+
			items+'"'+
			td.close();
		}
		...
		th(id, txt, classes, attributes, arr) {
			...
			return th.sopen(id, txt, classes, attributes)+'"+'+
			items+'"'+
			th.close();
		}
		...
		standardTable(id, txt, classes, attributes, obj) {
			...
			for (var i=0; i<arr[0].length;i++) {
				titles.push(sbuild.th("",arr[0][i],"","",[]));
			}
			for (var j=1; j<arr.length;j++) {
				for (var i=0; i<arr[j].length;i++) {
				items.push(sbuild.td("",arr[j][i],"","",[]));
				}
				allitems.push(sbuild.tr("","","","",items));
				items=[];
			}
			return sbuild.table("","",classes+" "+obj.textalign,"",[
			sbuild.thead("","","","",[
				sbuild.tr("","","","",titles)
			]),
			sbuild.tbody("","","","",
